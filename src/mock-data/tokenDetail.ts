...
export function generateBuyOrders(_basePrice: number): OrderBookEntry[] {
  const prices = [0.0018, 0.0020, 0.0021, 0.0022, 0.0024, 0.0025, 0.0028, 0.0030, 0.0035, 0.0036];
  const amounts = [38.76, 34.88, 99.67, 6.34, 46.51, 195.36, 99.67, 23.26, 139.54, 111.11];
  const collaterals = [0.50, 0.50, 1.50, 0.10, 0.80, 3.50, 2.00, 0.50, 3.50, 400.00];
...
export function generateSellOrders(_basePrice: number): OrderBookEntry[] {
  const prices = [0.0015, 0.0015, 0.0015, 0.0015, 0.0015, 0.0014, 0.0013, 0.0012, 0.0011, 0.0010];
  const amounts = [279.08, 139.54, 186.05, 93.03, 186.05, 199.34, 53.67, 12.50, 2.73, 100.00];
  const collaterals = [3.00, 1.50, 2.00, 1.00, 2.00, 2.00, 0.50, 15.00, 3.00, 100.00];
